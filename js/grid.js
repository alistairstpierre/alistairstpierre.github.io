...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$content = $('<div class="og-content"></div>').append(this.$section_01_aligncontainer, this.$section_02_aligncontainer, this.$section_03_aligncontainer);
			this.$closePreview = $( '<span class="og-close"></span>' );
			this.$previewInner = $( '<div class="og-expander-inner"></div>' ).append( this.$closePreview, this.$fullimage, this.$content);
		...
		update : function( $item ) {
			...
			this.$teamsize.html( eldata.teamsize );
			this.$teamsize.html( eldata.teamsize );
			this.$duration.html( eldata.duration );
			this.$learningtext.html( eldata.learningtext );
		...
		calcHeight : function() {
			...
			var heightPreview = winsize.height/2 - this.$item.data( 'height' ) - marginExpanded,
